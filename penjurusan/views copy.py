...
def hasil_tes(request):
    if request.method == 'GET':
        ...
        # Prediksi jurusan
        predicted_jurusan = knn.predict([riasec_vector])[0]

        # Ambil data jurusan
        try:
            rekomendasi_jurusan = Jurusan.objects.get(nama_jurusan=predicted_jurusan)
        ...
        Penjurusan.objects.create(
            user=user,
            tes=tes,
            jurusan=rekomendasi_jurusan   # Jurusan yang direkomendasikan
        )
