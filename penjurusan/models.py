...
class Penjurusan(models.Model):
    ...
    tes = models.ForeignKey(Tes, on_delete=models.CASCADE)
    jurusan_1 = models.ForeignKey(Jurusan, on_delete=models.CASCADE, related_name='jurusan_utama', null=True, blank=True)
    jurusan_2 = models.ForeignKey(Jurusan, on_delete=models.CASCADE, related_name='jurusan_alternatif_1', null=True, blank=True)
    jurusan_3 = models.ForeignKey(Jurusan, on_delete=models.CASCADE, related_name='jurusan_alternatif_2', null=True, blank=True)
